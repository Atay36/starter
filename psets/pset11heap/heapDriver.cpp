...
void heapprint_mode(heap hp, int mode) {
...
int main(int argc, char* argv[]) {
	...
	string menuCBT = "Complete BinaryTree(CBT): ";
	string menu;
	...
	do {
		...
		case 's':	// heapsort 
			...
			setType(hp, maxType);
			ordered = true;
			// ordered = false;  // since it's not a heap ordered any more
			break;
		...
		case 'x':	// grwo N nodes with unique random keys to heap or CBT
